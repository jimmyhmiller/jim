...
fn register_host_functions(
    ...
    jim_style::register_script_host_fns(engine);
    ...
    //
    // These deliberately shadow `jim_style`'s shader-pipeline `emit`
...
mod tests {
    ...
    fn emit_with_string_payload_does_not_hit_shader_bus() {
        ...
        // overload), not silently vanish into jim_style's `emit`.
        let src = r#"
            fn render(w, h) { }
