...
//! widget panes.
//!
//! The widget protocol is defined in `jim_widget::protocol`. This
...
use jim_widget::protocol::{Element, HostEvent, WidgetMsg};
...
//
// Duplicated on purpose: pulling in `jim_app` to share the type
// would drag libghostty-vt's dylib into this CLI. The format is small
// and changes rarely; keep this in sync with `jim_app::ipc`.
