...
fn radial_render(
    ...
    // savings.
    let bg_backdrop = Color::LinearRgba(theme.color(jim_style::tokens::RADIAL_BACKDROP));
    let wedge = Color::LinearRgba(theme.color(jim_style::tokens::RADIAL_WEDGE));
    let wedge_hover = Color::LinearRgba(theme.color(jim_style::tokens::RADIAL_WEDGE_HOVER));
    let deadzone = Color::LinearRgba(theme.color(jim_style::tokens::RADIAL_DEADZONE));
    let deadzone_ring = Color::LinearRgba(theme.color(jim_style::tokens::RADIAL_DEADZONE_RING));
    let label = Color::LinearRgba(theme.color(jim_style::tokens::RADIAL_LABEL));
    let label_hover = Color::LinearRgba(theme.color(jim_style::tokens::RADIAL_LABEL_HOVER));
    let icon = Color::LinearRgba(theme.color(jim_style::tokens::RADIAL_ICON));
