...
use jim_inference::classifiers::{classify_command_suggestion, classify_default_cwd};
use jim_inference::event_kinds::{
    COMMAND_PANE_SUGGESTED, PROJECT_DEFAULT_CWD_SUGGESTED, TERMINAL_COMMAND_EXECUTED,
    TERMINAL_CWD_CHANGED,
};
use jim_inference::llm::LlmConfig;
...
fn publish_suggestion(
    ...
    project_name: &str,
    cwd: &str,
    result: &jim_inference::classifiers::DefaultCwdClassification,
) {
